package com.navjot.android2020_37.util;
...
public class Resources {
    ...
    public static final MediaObject[] MEDIA_OBJECTS = {
            new MediaObject("1. Sending Data to a New Activity with Intent Extras",
            ...
            new MediaObject("2. REST API, Retrofit2, MVVM Course SUMMARY",
            ...
            new MediaObject("3. MVVM and LiveData",
            ...
            new MediaObject("4. Swiping Views with a ViewPager",
            ...
            new MediaObject("5. Database Cache, MVVM, Retrofit, REST API demo for upcoming course",
